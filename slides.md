...
バグを生む「伝達ミス・思い込み」を防ぐ仕組みとはどういうものか

---

# 要件が伝わらないと何が起きるか

<!-- 画像: images/swing.png を後で追加 -->
...
> 伝達ミスと思い込みが品質を壊さないよう、**合意と確認**を組み込んだ仕組み

- **合意**：何を作るかをチームと確認し、記録してから次へ進む
- **確認**：決めた通りに作れているかをレビューとテストで検証する
...
- 開発プロセス：**合意と確認**を組み込んだ仕組み — これが品質を決める
